...
pub fn build(b: *std.build.Builder) void {
    ...
    const exe = b.addExecutable("protein-translation", "src/main.zig");
    ...
    const test_exe = b.addTest("test/protein_translation_test.zig");
    test_exe.addPackagePath("protein_translation", "lib/protein_translation.zig");
