...
```zig
  ...
  test "array and slice array" {
    ...
    var array3: [6:88]u8 = [6:88]u8{0, 1, 2, 3, 4, 5};  // [N:sentinel]T - Sentinel-Terminated Arrays
    var array4: [6:88]u8 = [_:88]u8{0, 1, 2, 3, 4, 5};  // [_:sentinel]T - Sentinel-Terminated Arrays
...
const std = @import("std");
  ...
  test "const array and slice const array" {
    ...
    const array3: [6:88]u8 = [6:88]u8{0, 1, 2, 3, 4, 5};  // [N:sentinel]T - Sentinel-Terminated Arrays
    const array4: [6:88]u8 = [_:88]u8{0, 1, 2, 3, 4, 5};  // [_:sentinel]T - Sentinel-Terminated Arrays
